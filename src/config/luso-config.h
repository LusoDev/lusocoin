/* src/config/luso-config.h.  Generated from luso-config.h.in by configure.  */
/* src/config/luso-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LUSO_CONFIG_H

#define LUSO_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/lusodev/lusocoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Luso Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Luso Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lusocore"
