...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "LusoNetwork") type = LusoNetwork;
    if(strType == "LusoNetworkVariable") type = LusoNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == LusoNetwork) s = "LusoNetwork";
    if(type == LusoNetworkVariable) s = "LusoNetworkVariable";
