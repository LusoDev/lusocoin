 ...
 *
 *   // network
 *   CLusoNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.lusoco.in/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CLusoNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: LusoNetwork
// //   -- signature requirements : Key1(User)
// class CLusoNetworkVariable : public CGovernanceObject
// {
// private:
