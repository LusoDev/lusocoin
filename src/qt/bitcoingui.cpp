    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Luso Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Luso address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and luso: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Luso Core"), this);
    aboutAction->setStatusTip(tr("Show information about Luso Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Luso Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Luso addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Luso addresses"));
    ...
    openAction->setStatusTip(tr("Open a luso: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Luso Core help message to get a list with possible Luso Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Luso Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Luso network", "", count));
    } else {
...
{
    QString strTitle = tr("Luso Core"); // default title
