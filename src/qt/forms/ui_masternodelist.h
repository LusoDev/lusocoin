...
public:
    ...
    void setupUi(QWidget *MasternodeList)
    {
        ...
        tableWidgetMasternodes->setHorizontalHeaderItem(6, __qtablewidgetitem13);
        QTableWidgetItem *__qtablewidgetitem14 = new QTableWidgetItem();
        tableWidgetMasternodes->setHorizontalHeaderItem(7, __qtablewidgetitem14);
    ...
    void retranslateUi(QWidget *MasternodeList)
    {
        ...
        ___qtablewidgetitem8->setText(QApplication::translate("MasternodeList", "Country", 0));
        QTableWidgetItem *___qtablewidgetitem9 = tableWidgetMasternodes->horizontalHeaderItem(2);
        ___qtablewidgetitem9->setText(QApplication::translate("MasternodeList", "LUSO?", 0));
        QTableWidgetItem *___qtablewidgetitem10 = tableWidgetMasternodes->horizontalHeaderItem(3);
        ___qtablewidgetitem10->setText(QApplication::translate("MasternodeList", "Protocol", 0));
        QTableWidgetItem *___qtablewidgetitem11 = tableWidgetMasternodes->horizontalHeaderItem(4);
        ___qtablewidgetitem11->setText(QApplication::translate("MasternodeList", "Status", 0));
        QTableWidgetItem *___qtablewidgetitem12 = tableWidgetMasternodes->horizontalHeaderItem(5);
        ___qtablewidgetitem12->setText(QApplication::translate("MasternodeList", "Active", 0));
        QTableWidgetItem *___qtablewidgetitem13 = tableWidgetMasternodes->horizontalHeaderItem(6);
        ___qtablewidgetitem13->setText(QApplication::translate("MasternodeList", "Last Seen", 0));
        QTableWidgetItem *___qtablewidgetitem14 = tableWidgetMasternodes->horizontalHeaderItem(7);
        ___qtablewidgetitem14->setText(QApplication::translate("MasternodeList", "Payee", 0));
