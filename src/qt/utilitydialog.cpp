    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Luso Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Luso Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  luso-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Luso in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 LUSO, 0.1 LUSO, 1 LUSO and 10 LUSO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://lusopay.atlassian.net/wiki/display/DOC/PrivateSend\">https://lusopay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Luso Core is shutting down...") + "<br /><br />" +
