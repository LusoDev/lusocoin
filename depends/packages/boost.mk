...
$(package)_config_opts+=threading=multi link=static -sNO_ZLIB=0 -sNO_COMPRESSION=0
...
$(package)_config_libraries=chrono,filesystem,iostreams,program_options,system,thread,test
