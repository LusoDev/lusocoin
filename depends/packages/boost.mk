...
define $(package)_build_cmds
  ./b2 -d2 -j2 -d1 --with-test --with-program_options --with-iostreams --with-chrono --with-filesystem --with-system --with-thread --prefix=$($(package)_staging_prefix_dir) $($(package)_config_opts) stage
endef
