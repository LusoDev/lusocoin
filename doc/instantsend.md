...
This mechanism has been integrated into Bitcore-Node-Luso which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/lusopay/insight-api-luso#web-socket-api](https://github.com/lusopay/insight-api-luso#web-socket-api)
* API: [https://github.com/lusopay/insight-api-luso#instantsend-transactions](https://github.com/lusopay/insight-api-luso#instantsend-transactions)
...
By default, the Luso Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Luso Core daemon:
