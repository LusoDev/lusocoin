...
Only requiring some minor changes is luso.cpp.
...
Changes to luso.cpp
----------------------
luso.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
