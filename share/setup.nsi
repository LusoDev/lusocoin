...
!else
InstallDir $PROGRAMFILES\LusoCore
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-luso executable and locales:
    Delete /REBOOTOK $INSTDIR\luso.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\luso-qt.exe
    ...
    WriteRegStr HKCR "luso" "URL Protocol" ""
    WriteRegStr HKCR "luso" "" "URL:Luso"
    WriteRegStr HKCR "luso\DefaultIcon" "" $INSTDIR\luso-qt.exe
    WriteRegStr HKCR "luso\shell\open\command" "" '"$INSTDIR\luso-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\luso-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\Luso.lnk"
